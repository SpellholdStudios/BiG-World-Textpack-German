...
IF NOT EXIST "%MAIN_DIR%" (
    ...
    echo Es ist fÅr die Installation zwingend erforderlich
...
echo.
echo.
echo.           Ihr kînnt eine alternative Textversion fÅr die deutschen
echo.           Texte wÑhlen. Dadurch werden die ansonsten unterschiedlichen
echo.           Beschreibungen der GegenstÑnde und Zauber vereinheitlicht.
echo.
